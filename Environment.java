...
public class Environment extends SimStateSweep {
	...
	public boolean groups_or_patches = false; //Multiple agents can be in the same location or what we will call group or patch
	...
	public void setGroups_or_patches(boolean patches) {
		this.groups_or_patches = patches;
	}
	...
	public void makeAgents() {
		if(!groups_or_patches) { //if patches != true, then make sure there are enough locations for all the agents
